...
let filterFalse = document.getElementById("filterFalse")
let ageFilter = document.getElementById("age")
let liveInKyiv = document.getElementById("liveInKyiv")
let filter = document.getElementsByClassName("filter")[0]


filterFalse.onclick = function () {
    filter.innerHTML = ""
    if (filterFalse.checked) {
...
liveInKyiv.onclick = function () {
    filter.innerHTML = ""
    if (liveInKyiv.checked) {
        for (const user of usersWithAddress) {
